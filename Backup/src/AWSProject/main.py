...
def create_back_up_plans(hrs, Env, Dep):
    backupIns = backup.Backup(backup_client)
    backupIns.create_backup_plan(hrs, Env, Dep)
...
def main():
    ...
    bucket_name = "new-backup-report-s3bucket"
    json_file_name = "json_file_from_path.json"
    json_content_type = "application/json"
    csv_file_name = "csv_file_from_path.csv"
    csv_content_type = "text/csv"

    # added creating backup plan with current resources. need to discuss whether appropriate. 

    # print("Creating backup plan with current Resources")

    # hours = 1
    # Env = 'prod'
    # Dep = 'sales'

    # create_back_up_plans(hours, Env, Dep)
    ...
    # end of the added creating backup plan with current resources. 
